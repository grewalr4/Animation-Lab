...
void MainFrame::Initialize()
{
    ...
    Bind(wxEVT_COMMAND_MENU_SELECTED, &MainFrame::OnLaboratory, this, XRCID("LaboratoryMenu"));
...
/**
 * Handle laboratory menu event
 * @param event The menu command event
 */
void MainFrame::OnLaboratory(wxCommandEvent& event)
{
