...
private:
    ...
    /// Laboratory for this picture
    std::shared_ptr<LaboratoryDrawable> mLaboratoryDrawable = nullptr;
...
public:
    ...
    */
    ...
    /**
     * Get the laboratory drawable in this picture
     * @return pointer to laboratory drawable
     */
    std::shared_ptr<LaboratoryDrawable> GetLaboratoryDrawable() { return mLaboratoryDrawable; }

    /**
     * Set the laboratory drawable in this picture
     * @param laboratoryDrawable LaboratoryDrawable to set
     */
    void SetLaboratoryDrawable(std::shared_ptr<LaboratoryDrawable> laboratoryDrawable) { mLaboratoryDrawable = laboratoryDrawable; }
};
